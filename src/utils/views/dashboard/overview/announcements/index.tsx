  ...
  return (
    <div className={cn("flex flex-col scrollbar", s.view)}>
      ...
      <ul className={cn(s.list, "scrollbar")}>
        <AnnouncementItem setRoute={props.navigator.setRoute} />
        <AnnouncementItem isDraft={true} setRoute={props.navigator.setRoute} />
        <AnnouncementItem isDraft={true} setRoute={props.navigator.setRoute} />
        <AnnouncementItem isDraft={true} setRoute={props.navigator.setRoute} />
        <AnnouncementItem isDraft={true} setRoute={props.navigator.setRoute} />
        <AnnouncementItem isDraft={true} setRoute={props.navigator.setRoute} />
      ...
      <div className="flex flex-col">
        ...
        <ul className={cn(s.list, "scrollbar max-h-[360px]")}>
    ...
    <div className={cn(s.root, "h-full", className)}>
      ...
      <TabPane>
        <TabPane.Tab name={"All"}>
          <AllAnnouncements navigator={navigator} />
        </TabPane.Tab>
